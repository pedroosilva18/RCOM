...
void printstatistics ()
{
    ...
    puts("Number of Bytes of the file stuffed: %d", stats.numBytesStuff);
    puts("Number of Bytes of the file recieved: %d B", stats.numBytesFile);
    puts("Number of REJ frames: %d", stats.numREJ);
    stats.numIframes = stats.numIframes + stats.numREJ;
    puts("Number of I frames sent: %d", stats.numIframes);
    puts("Number of Timeouts: %d", stats.numTimeouts);
    stats.numRetransmissions = stats.numREJ + stats.numTimeouts;
    puts("Number of Retransmissions: %d", stats.numRetransmissions);
